<template>
  <div>
    ...
    <el-table :data="tableData" style="width:100%">
      ...
      <el-table-column prop="lastMessageTime" label="时间" />
       <el-table-column label="操作" width="100">
        <template #default="scope">
          <el-button type="primary" text @click="viewSessionDetail(scope.row)" size="small">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination 
...
const viewSessionDetail=(row)=>{
  ...
  //获取会话详情 调用接口获取会话详情 .then是返回的Promise对象
